...
const TableWrapper = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="group relative my-5 overflow-hidden rounded-xl border border-zinc-200/60 bg-white/40 shadow-sm backdrop-blur-md dark:border-white/10 dark:bg-zinc-900/40">
      {/* 左侧滚动边缘渐变遮罩 */}
      <div 
        className={cn(
