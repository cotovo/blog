...
export default function Hero({ socials = [], presentation, greetingElement, avatarBubbleElement }: HeroProps) {
  return (
    <div className="relative flex min-h-[calc(100svh-56px)] w-full items-center justify-center overflow-hidden pb-16 sm:pb-0">
      <div className="mx-auto flex max-w-5xl -translate-y-2 flex-col-reverse items-center justify-center gap-6 px-4 sm:-translate-y-8 lg:flex-row lg:gap-10 xl:gap-16 lg:px-8">
      ...
      <div className="absolute bottom-4 left-1/2 flex w-full -translate-x-1/2 flex-col items-center gap-1.5 text-center sm:bottom-10 sm:gap-3 [@media(max-height:700px)]:hidden">
