...
date: "2026-06-16"
category: "c-notes"
description: "枚举类型、结构体定义与内存对齐、联合体的使用"
---
### 枚举 Enum
>枚举: 
...
6
```
![思考一下，然后再继续](/static/c/c-aHR0cHM6Ly9pbWct.jpg)
**枚举是不是 int 类型？**
```c
enum color {
	red = 1, greem, yellow 
...
![问:为什么直接开始写程序?概念呢?答:这你去问翁恺老师](/static/c/c-aHR0cHM6Ly9pbWct.jpg)
看着这个问题简单,实际上稍微有点技巧.
给出下面四个特殊日期,大家可以思考一下:
...
**结构中有结构的数组**
![你品，你细品](/static/c/c-aHR0cHM6Ly9pbWct.jpg)
```c
struct point {
	int x;
	int y;
...
```
![union 的内存 ](/static/c/c-aHR0cHM6Ly9pbWct.png)
#### union 的常用场景
先看一下这段程序：
```c
typedef union {
...
```
这说明了chi的内存存储情况：
![chi的内存](/static/c/c-aHR0cHM6Ly9pbWct.png)
我们用计算机看一下 16 进制的 1234 是什么样子：
![16 进制的 1234 ](/static/c/c-aHR0cHM6Ly9pbWct.png)
