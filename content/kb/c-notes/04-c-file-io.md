...
date: "2026-06-16"
category: "c-notes"
description: "C语言文件操作：fopen、fclose、fread、fwrite及格式化IO"
---
**想看更好排版，可以看原文**
[点击看原文](https://mp.weixin.qq.com/s/H1Yp5miEf8NP4HdP8OECqg)

![本节思维导图](/static/c/c-aHR0cHM6Ly9pbWct.jpg)
### 文件
#### 格式化的输入输出
> `printf`
...
![](/static/c/c-aHR0cHM6Ly9pbWct.png)
<p >1.写一个c文件并完成编译</p>
</div>
...
```
例：
![写一个c程序](/static/c/c-aHR0cHM6Ly9pbWct.png)
![测试](/static/c/c-aHR0cHM6Ly9pbWct.png)
